...
|---|---|---|---|---|
| 1 | percentage | number | Yes | The value to interpret as a percentage. |

## Returns
number

## Behavior / Algorithm
1. Coerce the argument to a number.
2. Return value / 100.
...
|---|---|---|
| `=UNARY_PERCENT(100)` | `1` | Golden path |
| `=UNARY_PERCENT(50)` | `0.5` | Golden path |
...
Implement natively in the appropriate builtins module (e.g. `src/functions/builtins-google-sheets.ts`). Add inline KAT tests and, if the behavior depends on cell layout, a workbook fixture. Ensure parity with Google Sheets semantics. Reference URL: https://support.google.com/docs/answer/3093982?hl=en

## References
- [Google Sheets function list](https://support.google.com/docs/table/25273)
- [Google Docs Editors Help - UNARY_PERCENT](https://support.google.com/docs/answer/3093982?hl=en)
...
- Terms of Service 
 ...
 Enable Dark Mode Send feedback on... This help content & information General Help Center experience Search Clear search Close search Google apps Main menu 17907296340569703318 true Search Help Center false true true true true true 35 false false false false false
