...
|---|---|---|---|---|
| 1 | delimiter | string | Yes | The character or string to place between each concatenated value. |
| 2 | value_or_array1 | any | Yes | The value or values to be appended using delimiter . |
| 3 | value_or_array2_... | string | No |  |

## Returns
string

## Behavior / Algorithm
1. Coerce delimiter to text.
...
Implement natively in the appropriate builtins module (e.g. `src/functions/builtins-google-sheets.ts`). Add inline KAT tests and, if the behavior depends on cell layout, a workbook fixture. Ensure parity with Google Sheets semantics. Reference URL: https://support.google.com/docs/answer/3094077?hl=en

## References
- [Google Sheets function list](https://support.google.com/docs/table/25273)
- [Google Docs Editors Help - JOIN](https://support.google.com/docs/answer/3094077?hl=en)
...
- Terms of Service 
 ...
 Enable Dark Mode Send feedback on... This help content & information General Help Center experience Search Clear search Close search Google apps Main menu 2704453094815369253 true Search Help Center false true true true true true 35 false false false false false
