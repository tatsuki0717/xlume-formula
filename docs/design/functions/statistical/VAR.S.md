...
|---|---|---|---|---|
| 1 | value1 | number \| range/array (repeatable) | Yes | A number, cell reference, or range included in the sample variance calculation. Further values or ranges can be passed as additional arguments. |
