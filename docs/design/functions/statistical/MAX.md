...
|---|---|---|---|---|
| 1 | number1 | number \| range/array (repeatable) | Yes | A number, cell reference, or range compared against the current maximum. Further numbers or ranges can be passed as additional arguments. |
