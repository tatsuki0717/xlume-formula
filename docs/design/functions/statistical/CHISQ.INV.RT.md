...
|---|---|---|---|---|
| 1 | probability | number \| range/array | Yes | Is a probability associated with the chi-squared distribution, a value between 0 and 1 inclusive. |
