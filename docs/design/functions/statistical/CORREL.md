...
|---|---|---|---|---|
| 1 | array1 | number \| range/array | Yes | The first range of numeric values. |
| 2 | array2 | number \| range/array | Yes | The second range of numeric values, matching the size of data1. |
