...
|---|---|---|---|---|
| 1 | array | number \| range/array | Yes | Is the range or array of values to trim and average. |
| 2 | percent | number \| range/array | Yes | Is the fractional number of data points to exclude from the top and bottom of the data set. |
