...
|---|---|---|---|---|
| 1 | number | number \| range/array | Yes | Is the total number of objects. |
| 2 | number_chosen | number \| range/array | Yes | Is the number of objects in each permutation. |
