...
## Description
Checks whether a LAMBDA argument was omitted when the LAMBDA was called.
...
|---|---|---|---|---|
| 1 | argument | any | Yes | A parameter of the surrounding LAMBDA. |
...
## Examples
- `=LAMBDA(a, [b], IF(ISOMITTED(b), a, a+b))`
