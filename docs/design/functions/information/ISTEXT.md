...
## Description
Returns TRUE if the cell contents reference text.
...
|---|---|---|---|---|
| 1 | value | number \| string \| boolean \| range/array | Yes | The value to test; returns TRUE only when the value is text. |
