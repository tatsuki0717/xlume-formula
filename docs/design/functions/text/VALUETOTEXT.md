...
## Description
Returns text from any specified value, formatting numbers/dates/Booleans consistently.
...
|---|---|---|---|---|
| 1 | value | any | Yes | The value to convert. |
| 2 | format | any | No | 0 = concise (default) or 1 = strict. |
