...
## Description
Returns an array of text values from any specified range, concatenated with commas.
...
|---|---|---|---|---|
| 1 | array | range/array | Yes | The array or range to convert. |
| 2 | format | any | No | 0 = concise (default) or 1 = strict (quotes/escapes). |
