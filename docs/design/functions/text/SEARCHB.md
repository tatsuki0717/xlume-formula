...
## Description
Locates one text string within a second text string, using byte counts for DBCS languages.
...
|---|---|---|---|---|
| 1 | find_text | string | Yes | The text to find. |
| 2 | within_text | string | Yes | The text to search within. |
| 3 | start_num | any | No | The byte position to start the search. Defaults to 1. |
