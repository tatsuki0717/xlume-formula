...
|---|---|---|---|---|
| 1 | text | string \| range/array | Yes | Is the text string containing the characters you want to extract. |
| 2 | num_chars | number \| range/array | Yes | Specifies how many characters you want LEFT to extract; 1 if omitted. |
