...
## Excel Syntax
```excel
=IFS(test1, value1, test_or_value1, [test_or_value2], ...)
```

## Arguments
| # | Name | Type | Required? | Description |
|---|---|---|---|---|
| 1 | test1 | boolean | Yes | A logical test to evaluate. |
| 2 | value1 | any | Yes | The result when test1 is TRUE. |
| 3 | test_or_value | any (repeatable) | No | Additional test/value pairs. Each test must be followed by a value. |
