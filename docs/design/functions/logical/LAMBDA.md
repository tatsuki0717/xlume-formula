...
## Description
Creates a custom, reusable function value that can be called by name or inline.
...
|---|---|---|---|---|
| 1 | parameter | any (repeatable) | No | A value to pass into the LAMBDA. The last argument must be the calculation. |
| 2 | calculation | any | Yes | The formula to evaluate and return. |
...
## Examples
- `=LAMBDA(x, x+1)(5)`
- `=MYFUNC(A1) where MYFUNC is a named LAMBDA`
