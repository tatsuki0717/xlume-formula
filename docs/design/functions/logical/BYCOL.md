...
## Description
Applies a LAMBDA to each column of an array and returns an array of results (one per column).
...
|---|---|---|---|---|
| 1 | array | range/array | Yes | The array to iterate by column. |
| 2 | lambda | range/array | Yes | A LAMBDA that receives each column and returns a scalar or array. |
