...
|---|---|---|---|---|
| 1 | dimension | number \| range/array | Yes | Required. Dimension is an integer specifying the dimension of the unit matrix that you want to return. It returns an array. The dimension has to be greater than zero. |
