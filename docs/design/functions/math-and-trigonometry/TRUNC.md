...
|---|---|---|---|---|
| 1 | number | number \| range/array | Yes | Is the number you want to truncate. |
| 2 | num_digits | number \| range/array | Yes | Is a number specifying the precision of the truncation, 0 (zero) if omitted. |
