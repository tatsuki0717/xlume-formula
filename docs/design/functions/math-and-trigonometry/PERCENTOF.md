...
## Description
Returns the percentage of the total that a subset represents.
...
|---|---|---|---|---|
| 1 | data_subset | range/array | Yes | The range or value for the subset. |
| 2 | data_all | range/array | Yes | The range or value for the whole set. |
