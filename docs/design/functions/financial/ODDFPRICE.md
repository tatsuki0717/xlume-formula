...
| 4 | first_coupon | number \| string \| boolean \| range/array | Yes | Is the security's first coupon date, expressed as a serial date number. |
| 5 | rate | number \| string \| boolean \| range/array | Yes | Is the security's interest rate. |
| 6 | yld | number \| string \| boolean \| range/array | Yes | Is the security's annual yield. |
| 7 | redemption | number \| string \| boolean \| range/array | Yes | Is the security's redemption value per $100 face value. |
| 8 | frequency | number \| string \| boolean \| range/array | Yes | Is the number of coupon payments per year. |
| 9 | basis | number \| string \| boolean \| range/array | Yes | Is the type of day count basis to use. |
