...
| 3 | frequency | number \| string \| boolean \| range/array | Yes | Is the number of coupon payments per year. |
| 4 | basis | number \| string \| boolean \| range/array | Yes | Is the type of day count basis to use. |
