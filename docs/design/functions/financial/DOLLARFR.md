...
|---|---|---|---|---|
| 1 | decimal_dollar | number \| string \| boolean \| range/array | Yes | Is a decimal number. |
| 2 | fraction | number \| string \| boolean \| range/array | Yes | Is the integer to use in the denominator of a fraction. |
