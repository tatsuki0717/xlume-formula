...
| 3 | investment | number \| string \| boolean \| range/array | Yes | Is the amount invested in the security. |
| 4 | redemption | number \| string \| boolean \| range/array | Yes | Is the amount to be received at maturity. |
