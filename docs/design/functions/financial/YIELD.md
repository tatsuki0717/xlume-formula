...
| 4 | pr | number \| string \| boolean \| range/array | Yes | Is the security's price per $100 face value. |
| 5 | redemption | number \| string \| boolean \| range/array | Yes | Is the security's redemption value per $100 face value. |
