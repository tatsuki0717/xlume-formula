...
| 3 | coupon | number \| string \| boolean \| range/array | Yes | Is the security's annual coupon rate. |
| 4 | yld | number \| string \| boolean \| range/array | Yes | Is the security's annual yield. |
| 5 | frequency | number \| string \| boolean \| range/array | Yes | Is the number of coupon payments per year. |
