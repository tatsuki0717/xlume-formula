...
## Description
Counts the cells containing numbers in a database field that match the given criteria.
...
| 2 | field | number \| string \| range/array | Yes | The field whose numeric values are counted, given as a matching header name or as a 1-based column index within database. |
