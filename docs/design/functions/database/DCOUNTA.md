...
## Description
Counts the non-empty cells in a database field that match the given criteria.
...
| 2 | field | number \| string \| range/array | Yes | The field whose non-empty values are counted, given as a matching header name or as a 1-based column index within database. |
