...
## Description
Returns the maximum value in a database field that matches the given criteria.
...
| 2 | field | number \| string \| range/array | Yes | The field whose maximum value is returned, given as a matching header name or as a 1-based column index within database. |
