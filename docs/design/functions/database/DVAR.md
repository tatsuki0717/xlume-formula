...
## Description
Returns the sample variance of all values in a database field that match the given criteria.
...
| 2 | field | number \| string \| range/array | Yes | The field whose sample variance is calculated, given as a matching header name or as a 1-based column index within database. |
