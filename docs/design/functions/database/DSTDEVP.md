...
## Description
Returns the population standard deviation of all values in a database field that match the given criteria.
...
| 2 | field | number \| string \| range/array | Yes | The field whose population standard deviation is calculated, given as a matching header name or as a 1-based column index within database. |
...
## Examples
- `=DSTDEVP(A1:C10, "Sales", E1:E2)`
- `=DSTDEVP(A1:C10, 3, E1:F2)`
