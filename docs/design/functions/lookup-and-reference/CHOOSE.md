...
|---|---|---|---|---|
| 1 | index_num | number \| range/array | Yes | The 1-based position of the value to return. |
| 2 | value1 | range/array \| number \| string \| boolean (repeatable) | Yes | A value that can be returned. Further values can be passed as additional arguments. |
