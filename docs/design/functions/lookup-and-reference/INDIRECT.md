...
|---|---|---|---|---|
| 1 | ref_text | string \| range/array | Yes | A text string that describes a reference. |
| 2 | a1 | boolean | No | TRUE (default) interprets ref_text as A1-style; FALSE as R1C1-style. |
