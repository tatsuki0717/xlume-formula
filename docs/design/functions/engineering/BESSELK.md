...
## Description
Returns the value of the modified Bessel function of the second kind, Kn(x).
...
|---|---|---|---|---|
| 1 | x | number \| string \| boolean \| range/array | Yes | The value at which the modified Bessel function is evaluated; must be greater than 0. |
