...
## Description
Returns the value of the Bessel function of the first kind, Jn(x).
...
|---|---|---|---|---|
| 1 | x | number \| string \| boolean \| range/array | Yes | The value at which the Bessel function is evaluated. |
