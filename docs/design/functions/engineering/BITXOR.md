...
|---|---|---|---|---|
| 1 | number1 | number \| range/array | Yes | The first non-negative integer to combine with a bitwise exclusive OR. |
| 2 | number2 | number \| range/array | Yes | The second non-negative integer to combine with a bitwise exclusive OR. |
