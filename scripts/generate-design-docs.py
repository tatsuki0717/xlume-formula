...
def parse_function_block(block):
    ...
    params = []
    # Match genuine {name: '...', description: '...'} parameter objects so the
    # detected parameter count matches HyperFormula's actual signature, but
    # capture only the name (prose is intentionally discarded).
